...
module FuncsDay7 where

import Data.Char
import Data.List
import CommonFuncs

data SeedCard = TWO | THREE | FOUR | FIVE | SIX | SEVEN | EIGHT | NINE | T | J | Q | K | A deriving (Bounded, Enum, Eq, Show)
...
parseType hc
    ...
    where counts = sort $ extractCountsFromCountSeed $ computeCountSeed hc
